...
export const vi: Translation = {
  strings: {
    ...
    selectionHintDrug: 'Thuốc này chữa được: {disorder}', selectionHintDisorder: 'Chọn đối thủ đang phơi nhiễm để gây Rối loạn này — không chọn được nơi đã có sẵn nó.', selectionHintTherapy: 'Loại bỏ một Rối loạn chưa điều trị của bạn — một số Rối loạn miễn nhiễm với Trị liệu.', selectionHintEpisode: 'Kích hoạt hiệu ứng Cơn phát bệnh lên một Rối loạn chưa điều trị của người chơi khác.',
  },
