...
export const vi: Translation = {
  strings: {
    ...
    logLocalStarted: 'Ván chơi cùng máy đã bắt đầu.', logDrew: '{player} rút {count} lá.', logDrug: '{player} dùng {drug} điều trị {disorder}.', logDisorder: '{player} gây {disorder} cho {target}.', logEpisode: '{player} kích hoạt Cơn phát bệnh của {disorder} lên {target}.', logTherapy: '{player} dùng Trị liệu loại bỏ {disorder}.', logDiscard: '{player} bỏ {card}.', logDiscardManual: '{player} chủ động bỏ {card}.', logEndTurn: '{player} kết thúc lượt.', logForfeit: '{player} xin thua.', unknownPlayer: 'Một người chơi', aCard: 'một lá bài', aDisorder: 'một Rối loạn',
  },
